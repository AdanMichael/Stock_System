...
class ResponseEnum(Enum):
    ...
    OUTER_INTERFACE_EXCEPTION = {'code': 1009, 'msg': 'IG507外部接口异常'}
    STOCK_LEVEL_INVALID = {'code': 1010, 'msg': '股票分时级别无效'}
    COMPANY_NOT_FOUND = {'code': 1011, 'msg': '公司信息不存在'}
    ...
    NoMoney_ERROR = {'code': 1020, 'msg': '资金不足'}
